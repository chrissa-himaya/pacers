...
class AwardController extends Controller
{
    ...
    {
        $columnHidden = array_merge($award->getDates(), ['id']);
        $columnLabels = [
            'code' => 'Award Code',
            'name'  => 'Award Name',
            'points'  => 'Point allocation',
        ];    
        $optionalFields = ['name', 'email'];

        $this->config_data = (object) [
            "module_name"=>"Awards", //Module name
            "module_perm_name"=>"award", //Permission name
            "module_route"=>"awards", //Web route
            "module_view_folder"=>"references.award", //View folder
    ...
    public function update(Request $request, Award $award)
    {
        ...
        $data = $request->all();
        $award->update($data);
        return redirect()->route($this->config_data->module_route . '.index', $award->id);
    }
    ...
    public function list(Request $request)
    {
        ...
        $columns = ['id', 'code', 'name', 'points', 'created_at', 'updated_at'];
