...
class PftHistoryController extends Controller
{
    ...
    public function __construct(PftHistory $pfthistory)
    {
        ...
        $this->config_data = (object) [
            "module_name" => "PFT History", //Module name
            "module_perm_name" => "pfthistory", //Permission name
            "module_route" => "pfthistories", //Web route
            "module_view_folder" => "officerdata.pfthistory", //View folder
