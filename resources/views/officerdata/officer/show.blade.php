        ...
        : route($config_data->module_route . '.update', [$officer->PM_CODE])
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="SRTY" class="form-control @error('SRTY') is-invalid @enderror"
                                value="{{ old('SRTY', $officer->SRTY) }}" disabled>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="PM_CODE" class="form-control @error('PM_CODE') is-invalid @enderror"
                                value="{{ old('PM_CODE', $officer->PM_CODE) }}" @disabled($operation_type === 'show')
                                disabled>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="NAME" class="form-control @error('NAME') is-invalid @enderror"
                                value="{{ old('NAME', $officer->NAME) }}" @disabled($operation_type === 'show')>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="RANK" class="form-control @error('RANK') is-invalid @enderror"
                                value="{{ old('RANK', $officer->RANK) }}" @disabled($operation_type === 'show') disabled>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="AFPSN" class="form-control @error('AFPSN') is-invalid @enderror"
                                value="{{ old('AFPSN', $officer->AFPSN) }}" @disabled($operation_type === 'show') disabled>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="AFPOS" class="form-control @error('AFPOS') is-invalid @enderror"
                                value="{{ old('AFPOS', $officer->AFPOS) }}" @disabled($operation_type === 'show')>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="SIG" class="form-control @error('SIG') is-invalid @enderror"
                                value="{{ old('SIG', $officer->SIG) }}" disabled>
                        ...
                        <div class="col-md-4">
                            ...
                            @else
                                <select name="SEX" class="form-control @error('SEX') is-invalid @enderror">
                                    ...
                                    <option value="M" {{ old('SEX', $officer->SEX) === 'male' ? 'selected' : '' }}>Male</option>
                                    <option value="F" {{ old('SEX', $officer->SEX) === 'female' ? 'selected' : '' }}>Female
                                    </option>
                                </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" name="DOR" class="form-control @error('DOR') is-invalid @enderror"
                                value="{{ old('DOR', $officer->DOR) }}" @disabled($operation_type === 'show')>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="TACS" class="form-control @error('TACS') is-invalid @enderror"
                                value="{{ old('TACS', $officer->TACS) }}" disabled>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" name="DOB" class="form-control @error('DOB') is-invalid @enderror"
                                value="{{ old('DOB', $officer->DOB) }}" @disabled($operation_type === 'show')>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" name="DOC" class="form-control @error('DOC') is-invalid @enderror"
                                value="{{ old('DOC', $officer->DOC) }}" @disabled($operation_type === 'show')>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="RET" class="form-control @error('RET') is-invalid @enderror"
                                value="{{ old('RET', $officer->RET) }}" @disabled($operation_type === 'show')>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="HCC" class="form-control @error('HCC') is-invalid @enderror"
                                value="{{ old('HCC', $officer->HCC) }}" @disabled($operation_type === 'show')>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="SOC" class="form-control @error('SOC') is-invalid @enderror"
                                value="{{ old('SOC', $officer->SOC) }}" @disabled($operation_type === 'show')>
                        ...
                        <div class="col-md-4">
                            ...
                            @if($operation_type === 'show')
                                <input type="text" class="form-control" value="{{ optional($officer->designations)->name }}"
                                    disabled>
                            @else
                        ...
                        <div class="col-md-4">
                            ...
                            @else
                                <select name="role_id" class="form-control select2 @error('role_id') is-invalid @enderror" disabled>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="REMARKS" rows="3" class="form-control @error('REMARKS') is-invalid @enderror"
                                @disabled($operation_type === 'show')>{{ old('REMARKS', $officer->REMARKS) }}</textarea>
